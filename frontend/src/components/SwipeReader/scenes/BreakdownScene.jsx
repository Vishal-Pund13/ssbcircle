  ...
  return (
    <div className="px-5 py-4 flex flex-col gap-4 h-full overflow-y-auto">
      <div>
        ...
        <p className="text-xs text-gray-400 mt-1 leading-relaxed">{intro}</p>
      </div>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3 px-3 py-3">
                <span className="w-8 h-8 bg-white rounded-md flex items-center justify-center text-base shadow-sm shrink-0">
                  {item.icon}
                </span>
                ...
                {item.stat && !isOpen && (
                  <span className="text-[10px] bg-gray-100 text-gray-500 rounded px-2 py-0.5 shrink-0 hidden sm:block">
                    {item.stat}
                  </span>
                )}
                <svg
              ...
              {isOpen && (
                <div className="px-3 pb-3 pt-0">
                  ...
                  {item.stat && (
                    <span className="inline-block mt-2 text-[10px] bg-brand-100 text-brand-600 rounded-full px-2.5 py-0.5 font-semibold">
                      {item.stat}
                    </span>
                  )}
                </div>
