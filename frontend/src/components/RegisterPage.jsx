    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 bg-slate-50">
      <div className="w-full max-w-sm">
        ...
        <div className="card">
          ...
          <p className="text-slate-500 text-sm mb-6">Join SSBCircle and start practising</p>
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1">3–20 chars, letters/numbers/underscore</p>
            </div>
            <div>
